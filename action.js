...
// node_modules/markdown-list-linter/lib/markdown-list-linter.min.js
var require_markdown_list_linter_min = __commonJS({
  'node_modules/markdown-list-linter/lib/markdown-list-linter.min.js'(
    ...
    var L = l((E, M) => {
      ...
      function q(t, e) {
        return b.IsJSONStr(t) && b.IsJSONStr(e)
          ? JSON.stringify(y(JSON.parse(t), JSON.parse(e)))
    ...
    var w = l((n) => {
      ...
      n.buildFormattedMessage =
        n.constructErrorObject =
        n.compareJson =
        n.sortItemsAlphabetically =
        n.getAllListItems =
        n.getAllHeadings =
          void 0
      var _ = p(),
        ...
        D = (t) => {
          switch (t) {
            ...
            case _.MarkdownListType.ListItems:
            default:
      ...
      var K = (t, e) => {
        let r = '',
          i = JSON.parse(t)
        return (
          Object.keys(i).reduce((s, o) => {
            let d = s.find((f) => f === o),
              c = s[s.length - 1]
            return (
              d || s.push(o),
              c && Number(o) - Number(c) > 1 && (r += j),
              (r += i[o] += k),
              s
            )
          }, []),
          {
            type: e,
            message: D(e),
            details: r.split(j).map(function (s) {
...
`
        ...
        d = (0, a.getAllHeadings)(o),
        c = (0, a.getAllListItems)(o),
        f = (0, a.sortItemsAlphabetically)([...d]),
        H = (0, a.sortItemsAlphabetically)([...c]),
        m = (0, a.compareJson)(d, f)
      ...
      let A =
          e.length < 1
            ...
            : { summary: 'Markdown list needs to be sorted', errorObject: e },
        R = (0, a.buildFormattedMessage)(A)
...
async function runMarkdownListLinterAction() {
  ...
  ;(0, core_1.setOutput)('formattedMessage', result.formattedMessage)
